...
# --- قاعدة المعرفة الاحترافية والنهائية (موسعة لتضمن 210+ زوج فريد) ---
KNOWLEDGE_BASE = {
    "RegistryTools": {
        "detailed_queries": [
            ...
            "What are the core functionalities of a modern service registry?",
            "Exploring Apache Zookeeper as a robust service discovery mechanism."
        ],
        "ground_truth_candidates": [
            ...
            "The role of Apache Zookeeper in coordinating distributed systems and managing configuration.",
            "Core components of a service registry: registration API, lookup API, and health checking."
        ],
    ...
    "DiscoveryPatterns": {
        "detailed_queries": [
            "An analysis of common microservice discovery patterns and their trade-offs.",
            ...
            "Explaining the 'service discovery per host' or 'shared registry' pattern."
        ],
        "ground_truth_candidates": [
            "A detailed comparison of Client-Side vs. Server-Side Discovery patterns and their primary use-cases.",
