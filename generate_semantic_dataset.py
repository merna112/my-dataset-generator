...
KNOWLEDGE_BASE = {
    "RegistryTools": {
        "detailed_queries": ["A comprehensive explanation of tools for service registries.", "Comparing features of HashiCorp Consul versus Netflix Eureka.", "How can a Key-Value store like etcd be used for service discovery?", "Best practices for leveraging DNS for service discovery in Kubernetes.", "An overview of service mesh technologies like Istio and their role in discovery."],
        "ground_truth_candidates": ["Using HashiCorp Consul for dynamic service registration and health checking.", "Implementing a registry with Netflix Eureka for Spring Boot applications.", "Leveraging DNS-based service discovery natively within Kubernetes (Kube-DNS).", "Using a distributed Key-Value store like etcd for discovery mechanisms.", "Integrating a service mesh like Istio to handle service discovery and traffic management."],
    ...
    "DiscoveryPatterns": {
        "detailed_queries": ["An analysis of common microservice discovery patterns.", "Trade-offs between client-side and server-side discovery.", "An architectural overview of how services locate each other.", "A deep dive into the Service Registry architectural pattern.", "How does the Sidecar pattern facilitate service discovery?"],
        "ground_truth_candidates": ["A detailed comparison of Client-Side vs. Server-Side Discovery patterns.", "Implementing the Client-Side Discovery pattern with a library like Netflix Ribbon.", "Implementing the Server-Side Discovery pattern using a reverse proxy.", "The role of the Service Registry in both discovery patterns.", "Using the Sidecar pattern (e.g., with Envoy proxy) to abstract discovery logic."],
    ...
    "HealthChecking": {
        "detailed_queries": ["Best practices for microservice health checking.", "How do service registries use health check status information?", "An overview of Kubernetes liveness and readiness probes.", "Differentiating between active and passive health checks."],
        "ground_truth_candidates": ["Implementing robust health checking mechanisms for microservices.", "Configuring active health checks by polling a dedicated HTTP /health endpoint.", "Using passive health checks by monitoring for failed connections.", "The distinct roles of Kubernetes Liveness, Readiness, and Startup probes."],
        "high_relevance": ["How registries use health status to update routing tables.", "Automatic removal of unhealthy service instances.", "Implementing custom health check logic.", "The importance of setting correct timeouts for health checks."],
    ...
    "APIGateway": {
        "detailed_queries": ["The role of an API Gateway in a microservices architecture.", "Comparing API Gateway tools like Kong, Traefik, and Spring Cloud Gateway.", "How API Gateways integrate with service discovery mechanisms.", "What are the benefits of using an API Gateway?"],
        "ground_truth_candidates": ["Using an API Gateway as a single entry point for all clients.", "Implementing routing and load balancing at the API Gateway level.", "Offloading cross-cutting concerns like authentication to the API Gateway.", "The API Gateway pattern vs. direct client-to-microservice communication."],
    ...
    "Observability": {
        "detailed_queries": ["Understanding observability in distributed systems.", "What are the three pillars of observability?", "Comparing centralized logging, distributed tracing, and metrics.", "How to implement distributed tracing for microservices?"],
        "ground_truth_candidates": ["The three pillars of observability: logs, metrics, and traces.", "Implementing distributed tracing with open-source tools like Jaeger or Zipkin.", "Aggregating logs from multiple services using the ELK stack or Fluentd.", "Monitoring microservices with Prometheus for metrics collection and Grafana for visualization."],
        ...
        "medium_relevance": ["The difference between monitoring and observability.", "Using structured logging for easier parsing.", "Introduction to time-series databases like InfluxDB.", "Cloud provider monitoring solutions (e.g., AWS CloudWatch)."],
    ...
    "ConfigurationManagement": {
        "detailed_queries": ["How to manage configuration for hundreds of microservices?", "Externalized configuration pattern explained.", "What is a distributed configuration store?", "Managing secrets in a microservices environment."],
        "ground_truth_candidates": ["Using a centralized, externalized configuration store like Spring Cloud Config Server or Consul KV.", "The Externalized Configuration pattern for decoupling services from their config.", "Managing secrets securely with a tool like HashiCorp Vault.", "Injecting configuration into containers using Kubernetes ConfigMaps and Secrets."],
        ...
        "medium_relevance": ["Using environment variables for configuration.", "Storing configuration in a version control system like Git.", "Feature flags and toggles for enabling/disabling features.", "The 12-Factor App methodology for building modern applications."],
